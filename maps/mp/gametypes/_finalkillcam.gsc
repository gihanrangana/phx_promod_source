...
getsongname(songnum)
{
	...
	{
	case 1:
		level.name = "DJ Raf - Jacky";
		break;
	case 2:
		level.name = "DJ Blyatman - Slav King";
		break;
	case 3:
		level.name = "DJ Raf - Techno Rock";
		break;
	case 4:
		level.name = "DJ RAF - Baju-Baj";
		break;
	case 5:
		level.name = "DJ Armani - Number One";
		break;
	case 6:
		level.name = "Devil Drumz - Welcome To The Show";
		break;
	case 7:
		level.name = "S.A.V. Project - Jump";
		break;
	case 8:
		level.name = "DJ Raf - Nastojasie Pacany ";
		break;
	case 9:
		level.name = "Kolbaser Project Mars Obibosov";
		break;
	case 10:
		level.name = "XS Project - Rashaet Pump";
		break;
	case 11:
		level.name = "Flux Pavilion - I Cant Stop";
		break;
	case 12:
		level.name = "KDrew - Bullseye";
		break;
	case 13:
		level.name = "Blue Stahli - Trash Glamour Rock Chick";
		break;
	case 14:
		level.name = "Sleaze";
		break;
	case 15:
		level.name = "Example - Changed The Way You Kiss Me";
		break;
	case 16:
		level.name = "Devin Martin - KILLBOT";
		break;
	case 17:
		level.name = "Celldweller - Tough Guy (Tim Ismag Remix)";
		break;
	case 18:
		level.name = "Britney Spears - Till The World Ends (Catex Remix)";
		break;
	case 19:
		level.name = "Swedish House Mafia - Dont you worry child";
		break;
	case 20:
		level.name = "WW - Lift Off";
		break;
	case 21:
		level.name = "Disturbed - Inside the fire";
		break;
	case 22:
		level.name = "Hollywood Undead - We Are";
		break;
	case 23:
		level.name = "AC DC - You Shook Me All Night Long";
		break;
	case 24:
		level.name = "Pantera - 5 Minutes Alone";
		break;
	case 25:
		level.name = "Tito Y Tarantula - After Dark";
		break;
	case 26:
		level.name = "Tame Impala - The Less I Know the Bette";
		break;
	case 27:
		level.name = "Sean Paul - She doesnt mind";
		break;
	case 28:
		level.name = "Michel Telo - Ai Se Eu Te Pego";
		break;
	case 29:
		level.name = "Tacata";
		break;
	case 30:
		level.name = "Pedro Sampaio - Galopa";
		break;
	case 31:
		level.name = "Imagine Dragons - Believer";
		break;
	case 32:
		level.name = "Linkin Park x Steve Aoki - A Light That Never Comes";
		break;
	case 33:
		level.name = "Starland Vocal Band - Afternoon Delight";
		break;
	case 34:
		level.name = "Imagine Dragons - Radioactive";
		break;
	case 35:
		level.name = "Streets Of Siam";
		break;
	case 36:
		level.name = "Ja sam pomalo gej";
		break;
	case 37:
		level.name = "Pink Guy - STFU";
		break;
	case 38:
		level.name = "Keckec - Sprzi me u ausvicu";
		break;
	case 39:
		level.name = "Levan Polka";
		break;
	case 40:
		level.name = "Dizzee Rascal - Bassline Junkie";
		break;
	case 41:
		level.name = "Sateliti - Crna dvojka";
		break;
	case 42:
		level.name = "Bajaga - Zivot je nekad siv";
		break;
	case 43:
		level.name = "Jurica Blazevic - Narkotik";
		break;
	case 44:
		level.name = "Mambole";
		break;
	case 45:
		level.name = "Gastoz - Aritmije";
		break;
	case 46:
		level.name = "Nucci - Lokalo";
		break;
	case 47:
		level.name = "Lepi - Pusti me";
		break;
	case 48:
		level.name = "Dragana - Pitaju me u mom kraju";
		break;
	case 49:
		level.name = "Jandrino jato - Malo Sladja malo Zorka";
		break;
	case 50:
		level.name = "Aleksandar Olujic - Harmonika";
		break;
	case 51:
		level.name = "Antiserum & Tha Trickaz - Boom";
		break;
	case 52:
		level.name = "8Er$ X KURK KOKANE X Mr. Bill - OUTRAGE";
		break;
	case 53:
		level.name = "Lil Nas X - Industry Baby";
		break;
	case 54:
		level.name = "Kernkraft 400 - K Theory Remix";
		break;
	case 55:
		level.name = "Who do you Voodoo Bitch";
		break;
	case 56:
		level.name = "Aero Chord - Drop it";
		break;
	case 57:
		level.name = "Aero Chord - Boundless";
		break;
	case 58:
		level.name = "Gioni x Marshvll - Rude";
		break;
	case 59:
		level.name = "AK AusserKontrolle x Bonez MC - In meinem Benz";
		break;
	case 60:
		level.name = "Tomsize x Simeon - Jump";
		break;
	case 61:
		level.name = "BladeMasterz - One Blade";
		break;
	case 62:
		level.name = "Dr. Peacock - Trip to Hell ft. Nosferatu";
		break;
	case 63:
		level.name = "Ownboss Mitch Briana - Perfect Stranger";
		break;
	case 64:
		level.name = "Tune Up - Ravers Fantasy";
		break;
	case 65:
		level.name = "Marko Nastic - U Are The Reason";
		break;
	case 66:
		level.name = "Blame The Mono - Spread Unison";
		break;
	case 67:
		level.name = "Oxia - Domino (David_Guetta Remix)";
		break;
	case 68:
		level.name = "Be My Lover - Julian Muller Mix";
		break;
	case 69:
		level.name = "Spanish Flies - The Music";
		break;
	case 70:
		level.name = "Dr. Peacock - Das Boot";
		break;
	}
}
